...
echo '
	<div class="uk-width-1-2@s margen-top-20">
		<ul class="uk-breadcrumb uk-text-capitalize">
			...
			<li><a href="index.php?rand='.rand(1,1000).'&seccion='.$seccion.'&subseccion=search&valor='.$valor.'&campo='.$campo.'" class="color-red">'.$valor.'</a></li>
		</ul>
	</div>
	...
	<div class="uk-width-1-2@s margen-top-20">
		<div uk-grid>
			<div>
				<label class="pointer"><i uk-icon="search"></i> Título</label>
			</div>
			<div class="uk-width-expand">
				<input type="text" class="uk-input search" data-campo="titulo">
			</div>
		</div>
	</div>
