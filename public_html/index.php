                                    ...
                                    <div class="hero-content text-center" data-aos="fade-up">
                                        ...
                                        <div class="hero-text-wrapper p-4 rounded-3" style="background: rgba(0, 0, 0, 0.4); backdrop-filter: blur(0px); box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3);">
                                            <h2 class="hero-subtitle h2 mb-3 fw-bold text-white" id="hero-subtitle">
                                                Bienvenidos al mundo de la simulación
                                            </h2>
                                            <p class="hero-tagline text-white mb-3 lead fst-italic opacity-90" id="hero-tagline">
                                                «Por la dignidad y seguridad del paciente»
                                            </p>
                                            <p class="hero-description mb-4 text-white" id="hero-description">
                                                Somos distribuidores líderes en simuladores médicos para la enseñanza,
                                                creación de centros de simulación multidisciplinarios y proyectos llave en mano.
                                            </p>
                ...
                <div class="swiper aliados-swiper">
                    <div class="swiper-wrapper align-items-center">
                        <?php if (!empty($home_aliados_carrusel)): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <!-- Fallback: Aliados — orden brief Pagina WEB.pdf (17 socios) -->
                            <div class="swiper-slide">
                                <div class="aliado-card">
                                    <div class="aliado-logo-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="aliado-card">
                                    <div class="aliado-logo-wrapper">
                                        <img src="<?php echo imageUrl('aliados/22-Tellyes.webp'); ?>"
                                             alt="Tellyes"
                                             class="aliado-logo"
                                             loading="lazy">
                                    </div>
            ...
            <div class="aliados-detalle-swiper swiper">
                <div class="swiper-wrapper">
                    <?php if (!empty($home_aliados_detalle)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <!-- Fallback: 17 aliados — orden Pagina WEB.pdf -->
                        <div class="swiper-slide">
                            <div class="aliado-detalle-card h-100">
                                <div class="aliado-logo-wrapper">
                                    <img src="<?php echo imageUrl('aliados/1-Gaumard.webp'); ?>"
                        ...
                        <div class="swiper-slide">
                            <div class="aliado-detalle-card h-100">
                                ...
                                <div class="aliado-info">
                                    <h4 class="aliado-name">SIMULAB</h4>
                                    <p class="aliado-description">Simulab desarrolla simuladores y entornos para entrenamiento quirúrgico y clínico de alta fidelidad. Su enfoque en realismo y seguridad del paciente refuerza nuestra oferta educativa.</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="aliado-detalle-card h-100">
                                ...
                                <div class="aliado-info">
                                    <h4 class="aliado-name">SIMBODIES</h4>
                                    <p class="aliado-description">
                                        Safeguard / SimBodies provee tecnología, equipamiento y entrenamiento en medicina de emergencia.
                        ...
                        <div class="swiper-slide">
                            <div class="aliado-detalle-card h-100">
                                ...
                                <div class="aliado-info">
                                    <h4 class="aliado-name">TELLYES</h4>
                                    <p class="aliado-description">Tellyes fabrica equipamiento y simuladores para formación en ciencias de la salud y enfermería. Su catálogo amplía nuestras soluciones con productos prácticos para instituciones educativas.</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="aliado-detalle-card h-100">
                                ...
                                <div class="aliado-info">
                                    <h4 class="aliado-name">NASCO HEALTHCARE</h4>
                                    <p class="aliado-description">
                        ...
                        <div class="swiper-slide">
                            <div class="aliado-detalle-card h-100">
                                ...
                                <div class="aliado-info">
                                    <h4 class="aliado-name">RÜDIGER</h4>
                                    <p class="aliado-description">
