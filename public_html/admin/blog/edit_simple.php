...
/**
 * ========================================
 * ADMIN - EDITAR ARTÍCULO (VERSIÓN SIMPLIFICADA)
 * ========================================
 */
...
<head>
    ...
    <title>Editar Artículo - Admin Blog</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="resumen" name="resumen" rows="3"><?php echo esc($articulo['resumen']); ?></textarea>
                            </div>

                            <!-- Contenido -->
                            <div class="mb-3">
                                <label for="contenido" class="form-label">Contenido *</label>
                                <textarea class="form-control" id="contenido" name="contenido" rows="10" required><?php echo esc($articulo['contenido']); ?></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="categoria_id" name="categoria_id">
                                    ...
                                    <option value="<?php echo $categoria['id']; ?>" 
                                            <?php echo $articulo['categoria_id'] == $categoria['id'] ? 'selected' : ''; ?>>
